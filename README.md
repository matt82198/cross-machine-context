...
***THIS IS PURELY AN EXAMPLE OF HOW TO CONFIGURE CLAUDE TO UTILIZE A MORE TOKEN EFFECICENT ORCHESTRATION AND PERSITANCE LAYER, YOU NEED TO BUILD YOUR MEMORIES, BEHAVIORS, ETC FROM SCRATCH. THE README FULLY WALKS THROUGH THIS. THIS IS INSPRIRED BY CLAUDE MEM AND SPECIFICALLY SOLVES THE CROSS SYTEM PROBLEM USING JUNCTIONS, AS WELL AS IMPROVING ON ORCHESTRATION TO LOWER TOKEN MODELS. CONTEXTS ARE ALSO ABLE TO PERSISTS ACROSS OPERATING SYSTEMS - ALLOWING FOR TEAMS TO SHARE THE SAME CONTEXT AND CONTINUALLY MAINTAIN IT JUST LIKE A STANDARD CODEBASE. PLEASE ACTUALLY READ THE DOCS, EXCUTE TESTS BEFORE PROVIDING COMPLETELY NONSENSE FEEDBACK AND DOWNVOTES.***
